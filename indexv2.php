	...
	<div id="page-container" class="fade">
		...
		<div class="login bg-white-transparent-1 animated fadeInDown">
			...
			<div class="login-header">
				<div class="brand">
					<span class="logo"></span>  Compra <b>eFX</b>
					<!--<small>responsive bootstrap 3 admin template</small>-->
                                        <small>Siempre compra eFX</small>
				</div>
				<div class="icon">
			...
			<div class="login-content">
				<form action="validar.php" method="POST" class="margin-bottom-0">
				    <div class="form-group m-b-20">
                                        <input type="text" name="nit" value="72280699" class="form-control form-control-lg inverse-mode" placeholder="Nit Empresa" required />
			            </div>	
                                    <div class="form-group m-b-20">
                                            <input type="text" name="user" value="admin" class="form-control form-control-lg inverse-mode" placeholder="Nombre de usuario" required />
					</div>
					<div class="form-group m-b-20">
                                            <input type="password" name="pass" value="123" class="form-control form-control-lg inverse-mode" placeholder="Contraseña" required />
					</div>
